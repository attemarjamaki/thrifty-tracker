  ...
  return (
    <div className="product-container">
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
            <div className="flex flex-col gap-2">
              <p className="text-2xl text-secondary font-semibold">{product.title}</p>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3">
                <div className="product-stars">
                  ...
                  <p className="text-sm text-primary-orange font-semibold">25</p>
                </div>
              ...
              <p className="text-sm text-black opacity-50">
                <span className="text-primary-green font-semibold">93%</span> of buyers recommend
                this.
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-16">
        ...
        <button className="btn w-fix mx-auto flex items-center justify-center gap-3 min-w-[200px]">
